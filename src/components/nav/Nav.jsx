...
function Nav() {
    return (
        <>
            <nav>
                <Link className='nav-item' to="/FavoritesPage"><svg width="30" height="30" viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link className='nav-item' to="/WatchList"><svg width="30" height="30" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
